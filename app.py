...
# Add Model1_largedata and Model2 to the system path
...
# Now you can import the scripts
import car_part_predictions
import damage_predictions

# Check if necessary packages are installed
def check_packages():
    required_packages = [
        "streamlit", "opencv-contrib-python-headless", "pandas", "numpy", "Pillow",
        "shapely", "torch", "torchvision", "matplotlib", "boto3", "tqdm"
    ]
